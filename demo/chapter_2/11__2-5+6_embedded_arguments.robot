*** Comments ***
[K1] Recall the concept of keywords with embedded arguments used in Behavior-Driven Specification and how they are documented
[K1] Recall how to use embedded arguments
